...
- [Upgrading to Better Auth 1.7](/llms.txt/docs/guides/1-7-upgrade-guide.md): Upgrade Better Auth from 1.6 to 1.7, including OAuth, OpenID Connect, MCP, SAML, SCIM, proxy, and custom adapter changes.
